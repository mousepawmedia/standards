...
# -*- coding: utf-8 -*-
#
# MousePaw Media Standards documentation build configuration file, created by
...
project = 'MousePaw Media Standards'
copyright = '2018 MousePaw Media. Licensed under CC-BY-SA 4.0'
